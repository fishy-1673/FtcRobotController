...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2135.0832814000914; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -268.59211101769324; // x position of the perpendicular encoder (in tick units)
    }
